...
export default async function AdminPage() {
  // middleware.ts already gates OWNER/ADMIN; auth() here is for display.
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <a
                      ...
                      className="truncate text-sm text-cb-blue hover:text-cb-blue-hover"
                    >
                      {f.webUrl}
                    </a>
                  </div>
                  {f.isPublicOverride && (
                    <span className="shrink-0 rounded-2xl bg-cb-blue-subtle px-3 py-1 text-xs font-medium text-cb-blue">
                      Public
                    </span>
                  )}
                </div>
